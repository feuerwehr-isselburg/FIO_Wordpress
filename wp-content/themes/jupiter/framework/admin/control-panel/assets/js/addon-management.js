...
(function($) {
    ...
    $(document).on('click', '.abb_addon_deactivate', function() {
        ...
        swal({
            ...
            mkDeactivateAddon($btn.data('slug'));
        });
    });
...
function mkAddonLoadingIndic($which_div, show_hide_status) {
    var loading_indic = '<div class="mk-addon-loading-holder"><div class="mk-btn-loading-spinner"></div></div>';
...
function mkDeactivateAddon(addon_slug) {
            ...
            if (response.hasOwnProperty('status')) {
                if (response.status == true) {
                    ...
                    swal({
                        ...
                        text: mk_language(mk_cp_textdomain.addon_deactivate_successfully, []),
                        type: "success",
                        html: true
                    });
                    return true;
