...
class Mk_SVG_Icons
{
    ...
    function __construct( $ajax_mode = true , $system_test_env = false) {
        ...
        add_action('wp_ajax_mk_get_icons_list', array(
            &$this,
            'get_icons_list'
        ));
        add_action('wp_ajax_nopriv_mk_get_icons_list', array(
            &$this,
            'get_icons_list'
        ));

        add_action('wp_ajax_mk_search_icons_by_name', array(
            &$this,
            'search_icon_by_name'
        ));
        add_action('wp_ajax_nopriv_mk_search_icons_by_name', array(
            &$this,
            'search_icon_by_name'
        ));
